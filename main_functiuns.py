...
from tensorflow.keras.layers import Input, Embedding, Reshape, LSTM, GRU, Dense, Flatten, Dropout, Conv1D, MaxPooling1D
from tensorflow.keras.utils import plot_model, to_categorical


EMBEDDING_DIM = 200  # 50, 100, 200 ou 300
...
def build_model_lstm(max_fatures, dim_embedding, embedding_matrix):
    """
    Création du modèle
...
if __name__ == '__main__':
    ...
    X = pd.concat([df['text_lemmatizer'][0:100000], df['text_lemmatizer'][860000:960000]])

    # y = df['polarity']
    y = pd.concat([df['polarity'][0:100000], df['polarity'][860000:960000]])
    ...
    if TRAIN:
        ...
        model = build_model_lstm(max_fatures=vocab_size, dim_embedding=EMBEDDING_DIM, embedding_matrix=embedding_matrix)
        # model = build_model_conv(max_fatures=vocab_size, dim_embedding=EMBEDDING_DIM, embedding_matrix=embedding_matrix)
